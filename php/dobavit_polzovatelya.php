...
<br>
<p>  
    <input type="submit" value="Зрегестрировать пользоватлея" id="btn">
...
<script>
    $(document).ready(function() {
        $("#btn").click(
            function(){
                NEWNAMESPACE.sendAjaxForm('box-1', 'ajax_form', 'dobavit_polzovatelya_obrabotchik.php');
                return false; 
            }
        );
    });
    ...
    $.ajax({
        url:     "php/dobavit_polzovatelya_obrabotchik.php", 
        type:     "POST",
        dataType: "html",
